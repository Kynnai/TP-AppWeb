...
describe('Login View', function() {
  ...
  it("15. Connexion Réussis l'onglet Connexion disparait de la nav-bar", function() {
    element(by.model('user.email')).sendKeys('Eti@test2.com');
    element(by.model('user.password')).sendKeys('asd');
    element(by.id('btnConnect')).click();
  ...
  it("16. Connexion Réussis l'onglet Inscription disparait de la nav-bar", function() {
    element(by.model('user.email')).sendKeys('Eti@test2.com');
    element(by.model('user.password')).sendKeys('asd');
    element(by.id('btnConnect')).click();
  ...
  it("17. Connexion Réussis redirection vers la page d'accueil", function() {
    element(by.model('user.email')).sendKeys('Eti@test2.com');
    element(by.model('user.password')).sendKeys('asd');
    element(by.id('btnConnect')).click();
  ...
  it("18. Connexion Échouer, le mots de passe n'est pas bon", function() {
    element(by.model('user.email')).sendKeys('Eti@test2.com');
  ...
  it("19. Connexion Échouer, le courriel n'est pas bon", function() {
  ...
  it("20. Connexion Échouer, tout les données son érroner", function() {
    element(by.model('user.email')).sendKeys('Eti@tes.com');
    element(by.model('user.password')).sendKeys('asdf');
    element(by.id('btnConnect')).click();
    expect(element(by.id('registrationMessage')).getText()).toBe('401 Bad credentials');
  ...
  it("21. Regarder si la page contient le champ pour entrer le mot de passe", function() {
    expect(element(by.id('inputUserPassword')).isDisplayed()).toBeTruthy();
  });

  it("22. Regarder si la page contient le model du champ pour entrer le mot de passe", function() {
    expect(element(by.model('user.password')).isDisplayed()).toBeTruthy();
  });

  it("23. Regarder si le message d'erreur pour le Courriel n'est pas visible", function() {
    expect(element(by.id('errorMessageEmail')).isDisplayed()).toBeFalsy();
  });

  it("24. Regarder si le message pour le Courriel fonctionne lorsqu'on efface le courriel", function() {
  ...
  it("25. Regarder si le message d'erreur pour le mot de passe n'est pas visible", function() {
    expect(element(by.id('errorMessagePassword')).isDisplayed()).toBeFalsy();
  });

  it("26. Regarder si le message pour le Courriel fonctionne lorsqu'on efface le mot de passe", function() {
    element(by.model('user.password')).sendKeys('asdf');
    element(by.model('user.password')).clear();
    expect(element(by.id('errorMessagePassword')).isDisplayed()).toBeTruthy();
  });

  it("27. Regarder si la page contient le bouton Envoyer", function() {
    expect(element(by.id('btnConnect')).isDisplayed()).toBeTruthy();
  });

  it("28. Regarder si le bouton Connecté est désactivé", function() {
    expect(element(by.id('btnConnect')).isDisabled);
  });

  it("29. Regarder si la page contient le bouton Effacer", function() {
    expect(element(by.id('btnErase')).isDisplayed()).toBeTruthy();
  });

  it("30. Regarder si le bouton Effacer fonctionne", function() {
    element(by.model('user.email')).sendKeys('Eti@tes.com');
    element(by.model('user.password')).sendKeys('asdf');
