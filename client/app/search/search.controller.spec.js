'use strict';
  ...
  describe('Ajax calls', function () {
    ...
    it('should display a message when server is down', function () {

      httpBackend.when('GET', 'http://www.omdbapi.com/?&s=baba').respond (500, { description: 'could not connect to BD'});
      ...
      expect(scope.messageErreur.length).toBeGreaterThan(0);
    });*/
